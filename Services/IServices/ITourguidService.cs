...
public interface ITourguidService
{
    ...
    Task<Result<TourguidPublicProfile>> PublicProfile(string id, string userid ,  CancellationToken cancellationToken = default);
    ...
    Task<Result> MoveTo(string tourguidid, string placeOrTrip, CancellationToken cancellationToken = default);
